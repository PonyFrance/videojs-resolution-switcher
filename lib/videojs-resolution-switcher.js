    ...
    var ResolutionMenuButton = videojs.extend(MenuButton, {
      constructor: function(player, options){
        ...
        if(options.dynamicLabel){
          ...
          this.el().querySelector('button').appendChild(this.label);
        }else{
          var staticLabel = document.createElement('span');
          videojs.dom.addClass(staticLabel, 'vjs-menu-icon');
          this.el().querySelector('button').appendChild(staticLabel);
        }
      ...
      function initResolutionForYt(player){
        ...
        if(!hls) { return; }
				...
				player.one('loadedmetadata', function(){
					var representations = hls.representations().sort(function(a, b) {
            return b.height - a.height;
					...
					var _customSourcePicker = function(_player, _sources, _label){
            var representations = _player.tech_.hls.representations().sort(function(a, b) {
              return b.height - a.height;
            });
            if(_label === 'auto'){
